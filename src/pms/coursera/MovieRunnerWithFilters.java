...
public class MovieRunnerWithFilters {
	...
	public void printAverageRatings() {
		...
		/*
		 * int num = 0; for (Rating currRating: ratings){ double currValue =
		 * currRating.getValue(); if(currValue != 0.0){ num += 1; } }
		 * System.out.println("There are " + num + " movies have " + numRating +
		 * " ratings.");
		 */
	}
	...
	public void printAverageRatingsByYearAfter() {
		...
		for (Rating currRating : ratings) {
			...
			if (currValue != 0.0) {
				num += 1;
				String currMovieID = currRating.getItem();
				System.out.println(currValue + "  " + MovieDatabase.getYear(currMovieID) + "  "
						+ MovieDatabase.getTitle(currMovieID));
			}
		}
		System.out.println(
				"There are " + num + " movies have at least " + numRating + " ratings and satisfy the filter.");
	}
	...
	public void printAverageRatingsByMinutes() {
		...
		int minMinutes = 105;
		int maxMinutes = 135;
		Filter filterMinutes = new MinuteFilter(minMinutes, maxMinutes);
	...
	public void printAverageRatingsByYearAfterAndGenre() {
		...
		filters.addFilters(filterYear);
		filters.addFilters(filterGenre);
		...
		System.out.println(
				"There are " + num + " movies have at least " + numRating + " ratings and satisfy the filters.");
	}
	...
	public void printAverageRatingsByDirectorsAndMinutes() {
		...
		AllFilters filters = new AllFilters();
		filters.addFilters(filterDirectors);
		filters.addFilters(filterMinutes);
